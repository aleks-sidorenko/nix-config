...
- [usmcamp0811/dotfiles](https://gitlab.com/usmcamp0811/dotfiles/-/blob/nixos/flake.nix) - Snowfall-based config
...
- [Misterio77/nix-config](https://github.com/Misterio77/nix-config) - mature and popular config
